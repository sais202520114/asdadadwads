...
# --- 1. 환경 설정 (차트 내 영어 사용하여 폰트 오류 원천 차단) ---
...
def plot_boxplot_and_stats(df_norm, df_raw):
...
def main():
    ...
    menu = st.sidebar.radio("선택", ['종합 요약 (표)', '사망/구조자 분석 (그래프)', '상관관계 분석', '박스 플롯'])
    ...
    if menu == '종합 요약 (표)':
        ...
        plot_boxplot_and_stats(data_norm, data_raw)
